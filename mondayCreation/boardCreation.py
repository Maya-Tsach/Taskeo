...
def create_item(board_id, group_id, task_name, time_estimation, column_ids, api_key):
...
def create_full_board(board_name, board_data, extra_columns=None, api_key=None):
    ...
    column_ids = {}
    column_ids["Time Estimation"] = create_column(board_id, "Time Estimation", "numbers", api_key=api_key)
